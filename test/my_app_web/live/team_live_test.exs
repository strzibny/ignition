defmodule MyAppWeb.TeamLiveTest do
  ...
  describe "Index" do
    ...
    test "lists all team", %{conn: conn, team: team} do
    ...
    test "saves new team", %{conn: conn} do
      ...
      assert index_live |> element("a", "New Teams") |> render_click() =~
               "New Teams"
      ...
      assert html =~ "Teams created successfully"
    ...
    test "updates team in listing", %{conn: conn, team: team} do
      ...
      assert html =~ "Teams updated successfully"
